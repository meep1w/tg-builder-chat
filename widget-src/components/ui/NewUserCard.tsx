  ...
  return (
    ...
    >
      ...
      <AutoLayout
        ...
        spacing={4}
      >
        <Text name="username" fill={WHITE} fontSize={15} fontWeight={700}>
          {username}
        </Text>
        <Text name="contact-status" fill={MUTED} fontSize={12} fontWeight={500}>
          Not a contact
        </Text>
      </AutoLayout>
      ...
      >
        ...
        >
          <AutoLayout width={90} horizontalAlignItems="end">
            <Text fill={MUTED} fontSize={12} fontWeight={500}>
              Phone Number
            </Text>
          </AutoLayout>

          {/* флаг + страна слева */}
          <AutoLayout width="fill-parent" horizontalAlignItems="start" spacing={4} verticalAlignItems="center">
            {flag && (
