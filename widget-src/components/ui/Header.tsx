...
interface HeaderProps extends ReqCompProps, Partial<AutoLayoutProps>, ContainsEvent<[TextEditEvent]> {
  /** Бэкап (старый) источник изображения аватарки — base64/URL */
  profilePicSrc: string
  /** Новый приоритетный источник — imageHash из вспомогательного плагина */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Новый приоритет: imageHash, иначе src */}
        <ProfilePic
