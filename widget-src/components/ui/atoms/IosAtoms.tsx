...
/** Import Changelog
 * - Status time now editable via right panel: useSyncedState("statusTime")
 * - Replaced SVG "clock" with Text showing statusTime (single source of truth)
 */
...
export function IosHeaderStatus({ theme, ...props }: IosHeaderProps) {
  ...
  // единственное время статус-бара — редактируемое из правой панели
